    ...
    >
      <div className="flex items-center gap-3">
        <div className="relative">
          ...
          />
          <div className="absolute -bottom-1 -right-1 w-5 h-5 rounded-full bg-[#F5C453] text-black flex items-center justify-center shadow">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-white/60 flex items-center gap-1 mt-0.5 font-medium">
            ...
            <span>Private Room Challenge</span>
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between px-3 py-2 rounded-xl bg-black/40 border border-white/10 text-xs font-mono">
        ...
        <div className="flex items-center gap-1.5">
          <span className="text-[11px] font-black text-[#F5C453] tracking-wider px-2 py-0.5 rounded bg-[#F5C453]/10 border border-[#F5C453]/20">
            {normalizedCode}
          </span>
      ...
      <div className="grid grid-cols-2 gap-2 pt-1">
        <button
          ...
          className="flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl bg-gradient-to-r from-[#F5C453] to-[#E5B544] text-black text-xs font-black uppercase tracking-wider hover:brightness-110 active:scale-95 transition-all shadow-lg cursor-pointer"
        >
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl bg-white/10 hover:bg-white/15 text-white/80 hover:text-white text-xs font-bold active:scale-95 transition-all cursor-pointer"
        >
          <X className="w-4 h-4" />
          Decline
        </button>
