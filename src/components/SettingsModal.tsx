  ...
  return (
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/85 backdrop-blur-xl animate-in fade-in duration-200 p-2 sm:p-4">
        <div className={`relative glass-panel rounded-3xl p-4 sm:p-6 w-full shadow-2xl overflow-y-auto max-h-[94vh] border border-blue-400/30 transition-all flex flex-col justify-between ${
          ...
          <div>
            ...
            <div className="flex items-center justify-between pb-3 border-b border-white/10 mb-4">
              <div className="flex items-center gap-3">
                <div className="p-2 rounded-2xl bg-blue-600/40 border border-blue-400/40 text-blue-400 shadow-md flex-shrink-0">
            ...
            <div className="space-y-2 mb-5">
              ...
              <div className="flex items-center gap-1.5 p-1 rounded-2xl bg-slate-900/90 border border-white/10 backdrop-blur-md overflow-x-auto no-scrollbar">
                <button
                ...
                <button
                  ...
                  className={`flex-1 min-w-[110px] flex items-center justify-center gap-1.5 py-2 px-3 rounded-xl text-xs font-bold transition-all cursor-pointer whitespace-nowrap ${
                    activeTab === 'database'
                      ? 'bg-gradient-to-r from-blue-800 to-blue-600 text-white shadow-md border border-emerald-400/60'
                ...
                <button
                  ...
                  className={`flex-1 min-w-[105px] flex items-center justify-center gap-1.5 py-2 px-3 rounded-xl text-xs font-bold transition-all cursor-pointer whitespace-nowrap ${
                    activeTab === 'logs'
                      ? 'bg-blue-900 text-white shadow-md border border-blue-400/60'
                      : 'text-blue-100/70 hover:text-white hover:bg-white/[0.06]'
                  }`}
                >
                ...
                <button
                  ...
                  className={`flex-1 min-w-[115px] flex items-center justify-center gap-1.5 py-2 px-3 rounded-xl text-xs font-bold transition-all cursor-pointer whitespace-nowrap ${
                    activeTab === 'authoring'
                      ? 'bg-blue-600 text-white shadow-md border border-blue-400/60'
                      : 'text-blue-100/70 hover:text-white hover:bg-white/[0.06]'
                  }`}
                >
              ...
              <div className="space-y-6 animate-in fade-in duration-150">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 py-1.5 px-3 rounded-xl bg-blue-600 text-white text-xs font-bold shadow-md shadow-blue-600/30 border border-blue-400/40 hover:scale-[1.02] active:scale-[0.98] transition-all cursor-pointer"
                  >
                    ...
                    return (
                      <div
                        ...
                        className={`group relative p-3.5 rounded-2xl border transition-all cursor-pointer backdrop-blur-md overflow-hidden ${
                          isSelected
                            ? 'bg-blue-600/30 border-blue-400 shadow-lg shadow-blue-400/15 ring-1 ring-blue-400'
                      ...
                      >
                        ...
                        <div className="flex items-start justify-between gap-2 mb-2 relative z-10">
                          ...
                          {isSelected && (
                            <div className="w-5 h-5 rounded-full bg-blue-400 flex items-center justify-center text-white shadow-sm shrink-0">
                              <Check className="w-3 h-3 stroke-[3]" />
                            </div>
                          )}
                        </div>

                        <p className="text-[11px] text-blue-100/80 line-clamp-2 mb-3 relative z-10 leading-relaxed">
                          {theme.description}
                        </p>
                        ...
                        <div className="flex items-center justify-between pt-2 border-t border-white/10 relative z-10">
                          <div className="flex items-center gap-1.5">
                            {isPeshmerga ? (
                              <span className="px-2 py-0.5 rounded-full text-[10px] font-bold bg-blue-400/20 text-blue-400 border border-blue-400/30 flex items-center gap-1">
                          ...
                          <button
                            ...
                            className="px-2.5 py-1 rounded-lg bg-white/5 hover:bg-white/10 text-xs text-blue-100/80 hover:text-white font-medium flex items-center gap-1.5 transition-all border border-white/10 hover:border-blue-400/40 cursor-pointer"
                      ...
                      {customThemes.map(theme => {
                        ...
                        return (
                          <div
                            ...
                            className={`group relative p-3.5 rounded-2xl border transition-all cursor-pointer backdrop-blur-md overflow-hidden ${
                              isSelected
                                ? 'bg-blue-600/30 border-blue-400 shadow-lg shadow-blue-400/20 ring-1 ring-blue-400'
                                : 'bg-white/[0.04] border-white/10 hover:bg-white/[0.08] hover:border-white/20'
                            }`}
                          >
                      ...
                      return (
                        <button
                          ...
                          className={`p-3.5 rounded-2xl border transition-all text-left backdrop-blur-md relative overflow-hidden cursor-pointer ${
                            isSelected
                              ? 'bg-blue-600/40 border-blue-400 text-white shadow-lg shadow-blue-400/20 ring-1 ring-blue-400'
                        ...
                        >
                          <div className="flex items-center justify-between mb-1.5">
                            ...
                            <span className={`text-[9px] font-black px-1.5 py-0.5 rounded ${
                              isSelected ? 'bg-blue-400 text-white' : 'bg-white/10 text-white/70'
                            }`}>
                              {theme.tag}
                            </span>
                          </div>
              ...
              <div className="space-y-3 animate-in fade-in duration-150">
                <div className="flex items-center justify-between p-3.5 rounded-2xl bg-white/[0.04] border border-white/10 backdrop-blur-md">
                  <div>
                    ...
                    <div className="text-[11px] text-blue-100/60">Audio for moves, captures, checks, and game over</div>
                  </div>
                  <button
                    ...
                    className={`w-11 h-6 rounded-full transition-colors relative border border-white/10 cursor-pointer ${
                      settings.sound ? 'bg-blue-600' : 'bg-white/10'
                    }`}
                  >
                    <span
                ...
                <div className="flex items-center justify-between p-3.5 rounded-2xl bg-white/[0.04] border border-white/10 backdrop-blur-md">
                  <div>
                    ...
                    <div className="text-[11px] text-blue-100/60">Display valid destination dots and capture rings</div>
                  </div>
                  <button
                    onClick={() => onUpdateSettings({ showLegalMoves: !settings.showLegalMoves })}
                    className={`w-11 h-6 rounded-full transition-colors relative border border-white/10 cursor-pointer ${
                      settings.showLegalMoves ? 'bg-blue-600' : 'bg-white/10'
                    }`}
                  >
                    <span
                      className={`block w-4 h-4 rounded-full bg-white transition-transform transform shadow-sm ${
                ...
                <div className="flex items-center justify-between p-3.5 rounded-2xl bg-white/[0.04] border border-white/10 backdrop-blur-md">
                  <div>
                    ...
                    <div className="text-[11px] text-blue-100/60">Real-time advantage engine gauge on side of board</div>
                  </div>
                  <button
                    onClick={() => onUpdateSettings({ showEvalBar: !settings.showEvalBar })}
                    className={`w-11 h-6 rounded-full transition-colors relative border border-white/10 cursor-pointer ${
                      settings.showEvalBar ? 'bg-blue-600' : 'bg-white/10'
                    }`}
                  >
                    <span
                      className={`block w-4 h-4 rounded-full bg-white transition-transform transform shadow-sm ${
                ...
                <div className="flex items-center justify-between p-3.5 rounded-2xl bg-white/[0.04] border border-white/10 backdrop-blur-md">
                  <div>
                    ...
                    <div className="text-[11px] text-blue-100/60">Show 1-8 and a-h notation on board borders</div>
                  </div>
                  <button
                    onClick={() => onUpdateSettings({ showCoordinates: !settings.showCoordinates })}
                    className={`w-11 h-6 rounded-full transition-colors relative border border-white/10 cursor-pointer ${
                      settings.showCoordinates ? 'bg-blue-600' : 'bg-white/10'
                    }`}
                  >
                    <span
                      className={`block w-4 h-4 rounded-full bg-white transition-transform transform shadow-sm ${
                ...
                <div className="flex items-center justify-between p-3.5 rounded-2xl bg-white/[0.04] border border-white/10 backdrop-blur-md">
                  <div>
                    ...
                    <div className="text-[11px] text-blue-100/60">Soft highlight on origin and target squares</div>
                  </div>
                  <button
                    onClick={() => onUpdateSettings({ highlightLastMove: !settings.highlightLastMove })}
                    className={`w-11 h-6 rounded-full transition-colors relative border border-white/10 cursor-pointer ${
                      settings.highlightLastMove ? 'bg-blue-600' : 'bg-white/10'
                    }`}
                  >
                    <span
                      className={`block w-4 h-4 rounded-full bg-white transition-transform transform shadow-sm ${
          ...
          <div className="pt-4 mt-4 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3">
            <div className="flex items-center gap-2 w-full sm:w-auto">
              ...
              <button
                ...
                className="flex-1 sm:flex-initial px-3 py-2 rounded-xl bg-blue-950/40 hover:bg-blue-900/50 border border-blue-500/40 text-blue-400 text-xs font-bold flex items-center justify-center gap-1.5 transition-all cursor-pointer"
              >
            ...
            <button
              onClick={onClose}
              className="w-full sm:w-auto px-6 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs transition-all shadow-lg shadow-blue-600/30 border border-blue-400/40 cursor-pointer"
            >
              Done & Save
            </button>
          </div>
